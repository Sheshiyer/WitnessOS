...
import { 
  archetypalFractalShader, 
  defaultArchetypalUniforms,
  type ArchetypalFractalUniforms 
} from './archetypal-fractals.glsl';
import type { ConsciousnessState, BreathState } from '@/types';
import type { HumanDesignSignature, EnneagramSignature } from '@/generators/archetypal/consciousness-signatures';
...
export class ArchetypalFractalMaterial {
  ...
  updateHumanDesignSignature(signature: HumanDesignSignature): void {
    ...
    this.uniforms.fractalType.value = fractalMap[signature.fractalPattern] ?? FractalType.MANDELBROT;
  }
